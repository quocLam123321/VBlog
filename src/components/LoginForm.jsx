        ...
        <CardContent className="p-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div className="space-y-1">
              <h1 className="text-2xl font-bold tracking-tight bg-linear-to-r from-slate-100 to-slate-300 bg-clip-text text-transparent">Welcome back</h1>
          ...
          <div className="text-center text-sm text-slate-400">
            ...
            <Link to="/auth/register" className="text-indigo-400 hover:text-indigo-300 font-semibold hover:underline transition-colors">
              Sign up
            </Link>
          </div>
        </CardContent>
